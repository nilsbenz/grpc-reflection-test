...
public class DynamicGrpcClient {
   ...
   public DynamicMessage callUnaryBlocking(DynamicMessage requestParam, CallOptions callOptions) {
      var responseObserver = new UnaryResultObserver<DynamicMessage>();
      callUnary(requestParam, responseObserver, callOptions);
